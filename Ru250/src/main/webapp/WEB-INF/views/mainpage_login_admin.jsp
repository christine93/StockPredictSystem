		...
		jQuery(function($) {
			...
			$( "#configuration" ).on('click', function(e) {
				...
				$( "#edit" ).removeClass('hide').dialog({
					resizable: false,
					modal: true,
					title: "<div class='widget-header'><h4 class='smaller'><i class='icon-warning-sign red'></i> Edit the configuration</h4></div>",
					title_html: true,
					buttons: [{
						html: "<i class='icon-edit bigger-110'></i>&nbsp;&nbsp;&nbsp;change",
